...
import { StyleSheet, Text, View,Button,Image , TouchableOpacity,StatusBar, Dimensions} from 'react-native';
            ...
            <View style={{flex:1}}>
                ...
                <View style={{flexDirection:'row',height:50,marginTop:15}}>
                    <View style={{flex:1,alignItems:'center', justifyContent:'center', backgroundColor:'white'}}>
                        <Text style={{color:StyleConst.COLORS.PRIMARY, fontWeight:'bold',paddingLeft:5}}>Login</Text>
                    </View>
                    <View style={{flex:4, alignItems:'center', justifyContent:'center', backgroundColor:'white'}}>
                        <Image  source={require('../img/logo.png')} resizeMode={"contain"} style={{height:30}}/>
                    </View>
                    <TouchableOpacity onPress={()=>this.props.navigation.navigate('DrawerOpen')}
                                      style={{flex:1, backgroundColor:'white',alignItems:'center', justifyContent:'center'}}>
                       <Ionicons name="md-more" size={30} color="black" style={{paddingLeft:5,color:StyleConst.COLORS.PRIMARY}}/>
                    </TouchableOpacity>
                </View>
